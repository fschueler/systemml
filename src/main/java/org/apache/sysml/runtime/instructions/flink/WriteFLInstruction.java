	...
	public void processInstruction(ExecutionContext ec)         
		...
		if (oi == OutputInfo.MatrixMarketOutputInfo || oi == OutputInfo.TextCellOutputInfo) {
			...
			if (isInputMatrixBlock) {
				...
				DataSet<Tuple2<Long, String>> rdd = (DataSet<Tuple2<Long, String>>)((MatrixObject) flec.getVariable(input1.getName())).getDataSetHandle().getDataSet();
				out = rdd.map(new DataSetConverterUtils.ExtractElement<Tuple2<Long, String>, String>(1)).returns(String.class);
			...
			IOUtils.saveAsHadoopFile(in1, fname, MatrixIndexes.class, MatrixBlock.class, SequenceFileOutputFormat.class);
